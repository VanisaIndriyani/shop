...
<nav id="siteNav" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-28 md:h-24 items-center">
            <div class="flex items-center gap-2">
                ...
                <a href="{{ url('/') }}" class="flex-shrink-0">
                    <img class="refrens-logo h-28 md:h-24 w-auto object-contain scale-150 origin-left" src="{{ asset('img/logoo.png') }}" alt="REFRENS">
                </a>
            </div>
